...
#  Created by Genus(TM) Synthesis Solution 21.14-s082_1 on Sat Mar 14 17:25:30 IST 2026
...
set_load -pin_load 0.15 [get_ports {P[15]}]
set_load -pin_load 0.15 [get_ports {P[14]}]
set_load -pin_load 0.15 [get_ports {P[13]}]
set_load -pin_load 0.15 [get_ports {P[12]}]
set_load -pin_load 0.15 [get_ports {P[11]}]
set_load -pin_load 0.15 [get_ports {P[10]}]
set_load -pin_load 0.15 [get_ports {P[9]}]
set_load -pin_load 0.15 [get_ports {P[8]}]
